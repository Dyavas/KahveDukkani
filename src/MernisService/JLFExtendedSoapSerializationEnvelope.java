...
public class JLFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JLFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JLFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JLFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JLFDateTimeConverter dateTimeConverter = new JLFStandardDateTimeConverter();

    public JLFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JLFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JLFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JLFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JLFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JLFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
