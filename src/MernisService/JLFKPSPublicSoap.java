...
public class JLFKPSPublicSoap
{
    ...
    public JLFKPSPublicSoap(){}

    public JLFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JLFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JLFExtendedSoapSerializationEnvelope envelope= new JLFExtendedSoapSerializationEnvelope(JLFExtendedSoapSerializationEnvelope.VER11);
